        ...
        <div class='accordion' id='accordionExample'>
            ...
            <div class='accordion-item'>
                ...
                <div id='collapseTwo' class='accordion-collapse collapse' aria-labelledby='headingTwo'
                     data-bs-parent='#accordionExample'>
                    <div class='accordion-body'>
                        <strong>Sim</strong>, todos os nossos questionários estão sujeitos a restrições de direitos de
                        autor,
                        mas permitimos aos nossos subscritores imprimir os questionários; desde que sejam reproduzidos
                        na
                        forma precisa que o nosso ‘software’ gera (cada folha deve mostrar os detalhes dos questionários
                        educativos no final do questionário).
                        A utilização de qualquer um dos materiais sem mostrar os detalhes dos Testes de Educação é uma
                        violação dos nossos direitos de autor.
                        Serão tomadas medidas legais contra qualquer escola que utilize os questionários sem a nossa
